...
--
-- Host: localhost:3306
-- Generation Time: Apr 05, 2024 at 05:29 AM
...
CREATE TABLE `brands` (
  ...
  `cover_photo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'default.png',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `cart_infos` (
  `id` bigint UNSIGNED NOT NULL,
  `ser` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `user_id` bigint UNSIGNED NOT NULL,
  ...
  `attr` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(9, '1882713a4c31660296c607edc34d7272', 1, 1, 710, '1', '120', '0', 'blank', '[]', '2024-01-24 23:37:51', '2024-01-24 23:37:51'),
(10, '80dbebc52b770f885e9c6e7dbfcc70a4', 1, 1, 711, '1', '16', '0', 'blank', '[]', '2024-01-24 23:38:21', '2024-01-24 23:38:21'),
(11, '80dbebc52b770f885e9c6e7dbfcc70a4', 1, 1, 711, '1', '16', '0', 'blank', '[]', '2024-01-24 23:38:30', '2024-01-24 23:38:30'),
(12, '82d343b2ef45c83791fe078beb474640', 1, 1, 713, '1', '35', '0', 'blank', '[]', '2024-01-24 23:38:37', '2024-01-24 23:38:37'),
(13, '80dbebc52b770f885e9c6e7dbfcc70a4', 1, 1, 711, '1', '16', '0', 'blank', '[]', '2024-01-24 23:39:08', '2024-01-24 23:39:08'),
(14, '8720e76fe7244d5b8010aa38303069a8', 1, 1, 703, '1', '130', '0', 'blank', '[]', '2024-03-25 03:54:00', '2024-03-25 03:54:00');
...
(26, 'Bags', 'bags', 1, 1, NULL, NULL, NULL, 'default.png', '2024-04-04 22:14:45', '2024-04-04 22:14:45');
...
CREATE TABLE `chats` (
  ...
  `admin_message_log` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `user_message_log` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `chats` (`id`, `user_id`, `send_id`, `message`, `admin_status`, `user_status`, `admin_message_log`, `user_message_log`, `created_at`, `updated_at`) VALUES
(10, 287, NULL, 'hello', 1, 1, 'incoming', 'outgoing', '2024-02-03 01:05:34', '2024-02-04 01:30:06'),
(11, 287, NULL, 'anyone are there?', 1, 1, 'incoming', 'outgoing', '2024-02-03 01:07:22', '2024-02-04 01:30:06'),
(12, 287, NULL, 'yes let me know about it', 1, 1, 'outgoing', 'incoming', '2024-02-03 01:07:40', '2024-02-04 01:30:06');
...
CREATE TABLE `customer_infos` (
  ...
  `distric` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(256, 287, 'Bangladesh', NULL, NULL, NULL, 'Dhaka', '1201', '2023-09-11 07:46:51', '2024-01-22 23:10:05'),
(260, 291, NULL, NULL, NULL, NULL, NULL, NULL, '2024-01-22 03:31:50', '2024-01-22 03:31:50'),
(261, 292, NULL, NULL, NULL, NULL, NULL, NULL, '2024-02-03 05:49:16', '2024-02-03 05:49:16');
...
CREATE TABLE `orders` (
  ...
  `thana` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `meet_time` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `post_code` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `pay_date` varchar(11) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `cart_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '0',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(77, 287, 'customer', '1SeEgHnuL7', '#00077', 'null', NULL, 'Bangladesh', 'Dhaka', 'Dhaka', 'Dhaka', 'Adabor', NULL, NULL, '01711111111', 'customer@gmail.com', NULL, '130.00', '130.00', 'Rocket', NULL, NULL, NULL, NULL, '11111111111', '111111111111', NULL, NULL, NULL, NULL, NULL, '', '120.00', '0.00', '250.00', 0, 0, 0, 1, 2, '1', '2024-01-22 04:29:08', '2024-01-22 04:29:08'),
(78, 287, 'customer', 'a9vhgYJncM', '#00078', 'null', NULL, 'Bangladesh', 'Dhaka', 'Dhaka', 'Dhaka', 'Adabor', NULL, NULL, '01313772543', 'customer@gmail.com', NULL, '130.00', '130.00', 'Rocket', NULL, NULL, NULL, NULL, '11111111111', '111', NULL, NULL, NULL, NULL, NULL, '', '130.00', '0.00', '260.00', 0, 0, 0, 1, 2, '1', '2024-01-22 04:30:17', '2024-01-22 04:30:17');
...
(77, 77, 1, 710, 'The Spicy For Red Tea By Arafah -50Gm', 'blank', '[]', 1, '120.00', '120.00', '120.00', '2024-01-22 04:29:08', '2024-01-22 04:29:08'),
...
(7, 'Terms & Condition', 'Terms & Conditions', '<div><b>Terms and Conditions</b></div><div><b>By using the Demo Shop website (\"Website\"), you agree to be bound by the following terms and conditions:</b></div><div><b><br></b></div><div><b>1. Use of the Website</b></div><div><b>By accessing and using this Website, you confirm that you are of legal age and agree to use it in compliance with all applicable laws and regulations.</b></div><div><b><br></b></div><div><b>2. User Accounts</b></div><div><b>When you create an account on our Website, you are responsible for maintaining the confidentiality of your account information and for all activities conducted under your account.</b></div><div><b><br></b></div><div><b>3. Product Information</b></div><div><b>We strive to provide accurate product information, but we do not warrant that product descriptions, prices, or other content on our Website are error-free.</b></div><div><b><br></b></div><div><b>4. Purchases</b></div><div><b>By making a purchase on our Website, you agree to pay the specified price for the product and any applicable taxes and shipping fees.</b></div><div><b><br></b></div><div><b>5. Shipping and Returns</b></div><div><b>Shipping and return policies are outlined in our Shipping &amp; Delivery and Return &amp; Refund policies.</b></div><div><b><br></b></div><div><b>6. Privacy</b></div><div><b>Your privacy is important to us. Please refer to our Privacy Policy for details on how we collect, use, and protect your personal information.</b></div><div><b><br></b></div><div><b>7. Intellectual Property</b></div><div><b>All content on this Website, including text, graphics, logos, and images, is protected by copyright and other intellectual property laws. You may not use our content without permission.</b></div><div><b><br></b></div><div><b>8. Termination</b></div><div><b>We reserve the right to terminate your account or access to our Website if you violate these Terms.</b></div><div><b><br></b></div><div><b>9. Changes to Terms</b></div><div><b>Demo Shop may update these Terms at any time. Any changes will be effective immediately upon posting on our Website.</b></div><div><br></div>', 1, 1, '2022-03-12 14:19:16', '2024-03-25 02:17:42'),
(8, 'Privacy & Policy', 'Privacy & Policy', '<div><div><b>Privacy Policy</b></div><div><b>At Demo Shop, we value your privacy and are committed to protecting your personal information. This Privacy Policy outlines how we collect, use, disclose, and safeguard your data when you use our website or services.</b></div><div><b><br></b></div><div><b>1. Information We Collect</b></div><div><b>1.1 Personal Information: We may collect personal information, such as your name, email address, shipping address, and payment details when you make a purchase or create an account.</b></div><div><b><br></b></div><div><b>1.2 Usage Data: We may gather information about how you interact with our website, including your IP address, browser type, pages visited, and the time and date of your visits.</b></div><div><b><br></b></div><div><b>2. How We Use Your Information</b></div><div><b>2.1 We use your personal information to process orders, provide customer support, and send you updates or promotional offers if you opt-in.</b></div><div><b><br></b></div><div><b>2.2 Usage data helps us improve our website\'s functionality and content, personalize your experience, and monitor the effectiveness of our marketing efforts.</b></div><div><b><br></b></div><div><b>3. Information Sharing</b></div><div><b>3.1 We do not sell, trade, or rent your personal information to third parties. Your data is only shared with trusted service providers who assist us in operating our website and conducting our business.</b></div><div><b><br></b></div><div><b>4. Security</b></div><div><b>4.1 We implement security measures to protect your personal information from unauthorized access, disclosure, alteration, or destruction.</b></div><div><b><br></b></div><div><b>5. Your Choices</b></div><div><b>5.1 You have the right to access, correct, or delete your personal information. You can also opt-out of promotional communications at any time.</b></div><div><b><br></b></div><div><b>6. Cookies and Tracking Technologies</b></div><div><b>6.1 Our website uses cookies and similar technologies to enhance your browsing experience. You can manage cookie preferences through your browser settings.</b></div><div><b><br></b></div><div><b>7. Changes to Privacy Policy</b></div><div><b>7.1 We may update our Privacy Policy periodically. Any changes will be posted on this page with an updated effective date.</b></div><div><b><br></b></div><div><b>8. Contact Us</b></div><div><b>8.1 If you have any questions or concerns regarding our Privacy Policy, please contact us at demo@lems.com</b></div></div>', 1, 1, '2022-03-12 14:19:33', '2024-03-25 02:17:11'),
...
(6, 77, 'bk', '11111', '1111', 0, '2024-01-22 04:30:26', '2024-01-22 04:30:26');
...
CREATE TABLE `products` (
  ...
  `spec` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `regular_price` varchar(111) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `whole_price` varchar(111) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `buying_price` varchar(111) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dis_type` int DEFAULT NULL,
  `discount_price` varchar(111) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `isbn` varchar(222) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `book_file` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `refer` int NOT NULL DEFAULT '0',
  `video` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `video_thumb` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `yvideo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `sku` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `prdct_extra_msg` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `product_images` (
  `id` bigint UNSIGNED NOT NULL,
  `product_id` bigint UNSIGNED NOT NULL,
  `color_attri` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `reviews` (
  ...
  `file2` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file3` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file4` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `file5` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(25, 'copy_right_text', '© Lems Copyright', '2021-04-30 05:44:50', '2024-01-14 06:52:56'),
...
(43, 'whatsapp', '01925015919', NULL, '2024-03-05 01:28:50'),
...
(49, 'shipping_charge', '80', NULL, '2024-03-25 03:54:57'),
...
(54, 'fb_pixel', NULL, NULL, '2024-03-05 01:27:23'),
...
(70, 'g_cod', 'true', '2023-02-28 11:00:52', '2024-03-05 01:25:00'),
(71, 'g_aamar', 'false', '2023-02-28 11:00:52', '2023-02-28 11:14:16'),
(72, 'g_uddok', 'true', '2023-02-28 11:00:52', '2024-02-02 11:22:38'),
...
(85, 'header_code', NULL, '2024-01-14 01:27:39', '2024-03-05 01:27:23'),
(92, 'mail_config', '0', '2024-01-21 00:49:58', '2024-01-21 00:49:58'),
(93, 'MAIL_DRIVER', 'smtp', '2024-01-21 00:49:58', '2024-01-21 00:49:58'),
(94, 'MAIL_HOST', NULL, '2024-01-21 00:49:58', '2024-04-04 22:08:01'),
(95, 'MAIL_PORT', NULL, '2024-01-21 00:49:58', '2024-04-04 22:08:01'),
(96, 'MAIL_USERNAME', NULL, '2024-01-21 00:49:58', '2024-04-04 22:08:01'),
(97, 'MAIL_PASSWORD', NULL, '2024-01-21 00:49:58', '2024-04-04 22:08:01'),
(98, 'MAIL_ENCRYPTION', 'ssl', '2024-01-21 00:49:58', '2024-01-21 01:31:25'),
(99, 'MAIL_FROM_ADDRESS', NULL, '2024-01-21 00:49:58', '2024-04-04 22:08:01'),
(100, 'MAIL_FROM_NAME', NULL, '2024-01-21 00:49:58', '2024-04-04 22:08:01'),
(101, 'SMS_API_URL', NULL, '2024-01-21 02:18:50', '2024-03-05 01:25:58'),
(102, 'SMS_API_KEY', NULL, '2024-01-21 02:18:50', '2024-03-05 01:25:58'),
(103, 'SMS_API_SENDER_ID', NULL, '2024-01-21 02:18:50', '2024-03-05 01:25:58'),
(104, 'regVerify', 'email', '2024-01-21 03:13:40', '2024-02-03 05:48:32'),
(105, 'recovrAC', 'email', '2024-01-21 03:13:40', '2024-04-04 22:08:14'),
(106, 'SITE_INFO_ADDRESS', 'Mirpur, Dhaka, Bangladesh', '2024-01-21 06:02:39', '2024-03-05 01:28:28'),
(107, 'SITE_INFO_PHONE', '+8801925015919', '2024-01-21 06:02:39', '2024-03-05 01:28:28'),
(108, 'SITE_INFO_SUPPORT_MAIL', 'info@finvasoft.com', '2024-01-21 06:02:39', '2024-03-05 01:28:28'),
(109, 'MAIN_MENU_STYLE', '1', '2024-01-23 23:56:30', '2024-02-05 22:30:00'),
(110, 'SLIDER_LAYOUT', '1', '2024-01-23 23:56:30', '2024-01-24 23:37:07'),
(111, 'SELLER_STATUS', '0', '2024-01-24 04:03:05', '2024-04-04 22:08:37'),
(112, 'TOP_CAT_STATUS', '1', '2024-01-24 04:11:40', '2024-01-24 23:37:07'),
(113, 'LATEST_PRODUCT_STATUS', '1', '2024-01-24 05:14:03', '2024-01-24 23:37:07'),
(114, 'FEATURE_PRODUCT_STATUS', '1', '2024-01-24 05:14:03', '2024-01-24 23:37:07'),
(115, 'HERO_SLIDER_1', '1', '2024-01-24 05:29:56', '2024-04-04 22:27:36'),
(116, 'HERO_SLIDER_2', '1', '2024-01-24 05:29:56', '2024-01-24 23:37:07'),
(117, 'SLIDER_LAYOUT_STATUS', '1', '2024-01-24 23:21:31', '2024-01-24 23:37:07'),
(118, 'CLASSIFIED_SELL_STATUS', '1', '2024-01-24 23:21:31', '2024-01-24 23:37:07'),
(119, 'SUB_CAT_PRODUCT_STATUS', '1', '2024-01-24 23:21:31', '2024-01-24 23:37:07'),
(120, 'MINI_CAT_PRODUCT_STATUS', '1', '2024-01-24 23:21:31', '2024-01-24 23:37:07'),
(121, 'EXTRA_CAT_PRODUCT_STATUS', '1', '2024-01-24 23:21:31', '2024-01-24 23:37:07'),
(122, 'BRAND_STATUS', '1', '2024-01-24 23:21:32', '2024-01-24 23:37:07'),
(123, 'CATEGORY_SMALL_SUMMERY', '1', '2024-01-24 23:21:32', '2024-01-24 23:37:07'),
(124, 'NEWS_LETTER_STATUS', '1', '2024-01-24 23:21:32', '2024-01-24 23:37:07'),
(125, 'MEGA_CAT_PRODUCT_STATUS', '1', '2024-01-24 23:32:47', '2024-01-24 23:37:07'),
(128, 'GUEST_CHECKOUT', '1', '2024-01-25 06:01:42', '2024-01-25 06:01:54'),
(129, 'NOTICE_STATUS', '0', '2024-01-30 00:15:52', '2024-01-30 00:23:48'),
(130, 'CUSTOM_NOTICE', 'Sell 200', '2024-01-30 00:15:52', '2024-01-30 00:21:47'),
(131, 'FLOAT_LIVE_CHAT', '0', '2024-02-04 00:56:51', '2024-02-04 01:18:18'),
(132, 'TOP_HEADER_STYLE', '2', '2024-02-05 09:53:51', '2024-04-04 00:43:32'),
(133, 'CHECKOUT_TYPE', '0', '2024-03-05 01:24:29', '2024-03-05 01:24:29'),
(134, 'shipping_free_above', '10000', '2024-03-05 01:24:29', '2024-03-05 01:24:29'),
(135, 'shipping_range_inside', 'Dhaka', '2024-03-05 01:24:29', '2024-03-05 01:24:29'),
(136, 'body_code', NULL, '2024-03-05 01:27:23', '2024-03-05 01:27:23'),
(137, 'FOOTER_COL_4_HTML', '<b>Payment Support: Bkash, Roacket, Nagad</b>', '2024-03-05 01:27:23', '2024-03-05 01:27:23'),
...
(149, 'HERO_SLIDER_1_TEXT', NULL, '2024-04-04 00:43:32', '2024-04-04 00:43:32'),
(150, 'TOP_CAT', NULL, '2024-04-04 00:43:32', '2024-04-04 00:43:32');
...
CREATE TABLE `shop_infos` (
  ...
  `selfi` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  ...
  `nidback` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
(117, 26, 'Common bag', 'common-bag', 'default.png', 1, 1, '2024-04-04 22:15:26', '2024-04-04 22:15:26');
...
CREATE TABLE `users` (
  ...
  `oauth_type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `joining_month` varchar(15) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 1, 'Finva Soft', 2, 'admin', 'asifulmamun@gmail.com', '01721600688', '$2y$10$zayBOfViYMB65kxVCJLGQuw9nBHkxyIVlVkHl1zjoWuMEWGHT2GOO', NULL, NULL, 1, 1, 0, '2023-09-05-64f771292bc07.jpg', 0, 0, '2021-04-30', 'April', 2021, '2021-04-30 05:44:48', 'XaRJAPppF2UYNGR9PvzOztkCuT2RY3IcS0r3XWtyuTbjcWRbyNiNeCdx25kp', 1, 0, '2021-04-30 05:44:48', '2024-01-18 07:31:08'),
(286, 2, 'Vendor', 2, 'vendor', 'vendor@gmail.com', '01710101010', '$2y$10$zayBOfViYMB65kxVCJLGQuw9nBHkxyIVlVkHl1zjoWuMEWGHT2GOO', NULL, NULL, 1, 1, 0, 'default.png', 0, NULL, '2023-09-11', 'September', 2023, NULL, NULL, NULL, 0, '2023-09-11 07:44:02', '2023-09-11 07:44:02'),
(287, 3, 'customer', 2, 'customer', 'customer@gmail.com', '01710101011', '$2y$10$zayBOfViYMB65kxVCJLGQuw9nBHkxyIVlVkHl1zjoWuMEWGHT2GOO', NULL, NULL, 1, 1, 0, '2024-01-23-65af4a2dcf1c3.JPG', 0, 0, '2023-09-11', 'September', 2023, NULL, NULL, NULL, 0, '2023-09-11 07:46:51', '2024-01-22 23:10:05'),
(291, 3, 'Finva', 2, 'finva4088', 'mamun.finvasoft@gmail.com', '01787841017', '$2y$10$DT72pvDDJanad4tjH.pOd.I6qid6pXU.G2r6WRM/vfgnJeS0OCk..', NULL, NULL, 1, 1, 0, 'default.png', 0, NULL, '2024-01-22', 'January', 2024, NULL, NULL, NULL, 0, '2024-01-22 03:31:50', '2024-01-22 04:11:51'),
(292, 3, 'xobaeer', 2, 'xobaeer1453', 'asmaakterkg@gmail.com', '01793658563', '$2y$10$Xbi7LhriOcLW81IURGUjHuTkocuHif/7Ayrf3OGA4Pn.PPOE4c/6u', NULL, NULL, 1, 1, 0, 'default.png', 0, NULL, '2024-02-03', 'February', 2024, NULL, NULL, NULL, 0, '2024-02-03 05:49:16', '2024-02-03 05:50:24');
...
(1, 1, '0.00', '250.00', NULL, '2024-01-22 04:30:17'),
