...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background:var(--optional_color)">
    <!-- Brand Logo -->
    <a href="{{route('admin.dashboard')}}" class="brand-link">
        <img src="/uploads/setting/{{setting('logo')}}" alt="Logo" class="brand-image" style="opacity: .8;float:none;width:90;margin: auto;">
    </a>
    <style>
        .nav-treeview {
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="align-items: center;">
            <div class="image">
                ...
                <img src="{{Auth::user()->avatar != 'default.png' ? '/uploads/admin/'.Auth::user()->avatar:'/default/user.jpg'}}" class="img-circle elevation-2" alt="User Image" style="width:50px;height:50px">
            </a>
            </div>
            <div class="info">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item {{Request::is('admin/author*') ? 'menu-is-opening menu-open':''}}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('admin.author.create')}}" class="nav-link {{Request::is('admin/staff/create') ? 'active':''}}">
                                <i class="fas fa-plus-circle nav-icon"></i>
                                <p>Add</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('admin.author.index')}}" class="nav-link {{Request::is('admin/staff/list') ? 'active':''}}">
                                <i class="fas fa-bars nav-icon"></i>
                                <p>List</p>
                            </a>
                        </li>
                ...
                <li class="nav-item {{Request::is('admin/category*') ? 'menu-is-opening menu-open':''}}">
                    ...
                    <ul class="nav nav-treeview">
                         <li class="nav-item {{Request::is('admin/category*') ? 'menu-is-opening menu-open':''}}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{routeHelper('category/create')}}" class="nav-link {{Request::is('admin/category/create') ? 'active':''}}">
                                        <i class="fas fa-plus-circle nav-icon"></i>
                                        <p>Add</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{routeHelper('category')}}" class="nav-link {{Request::is('admin/category') ? 'active':''}}">
                                        <i class="fas fa-bars nav-icon"></i>
                                        <p>List</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item {{Request::is('admin/sub-category*') ? 'menu-is-opening menu-open':''}}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{routeHelper('sub-category/create')}}" class="nav-link {{Request::is('admin/sub-category/create') ? 'active':''}}">
                                        <i class="fas fa-plus-circle nav-icon"></i>
                                        <p>Add</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{routeHelper('sub-category')}}" class="nav-link {{Request::is('admin/sub-category') ? 'active':''}}">
                                        <i class="fas fa-bars nav-icon"></i>
                                        <p>List</p>
                                    </a>
                                </li>
                ...
                <li class="nav-item {{Request::is('admin/slider*') ? 'menu-is-opening menu-open':''}}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{routeHelper('collection')}}" class="nav-link {{Request::is('admin/collection') ? 'active':''}}">
                                <i class="fas fa-bars nav-icon"></i>
                                <p>List</p>
                            </a>
                        </li>
                ...
                <li class="nav-item {{Request::is('admin/slider*') ? 'menu-is-opening menu-open':''}}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{routeHelper('slider')}}" class="nav-link {{Request::is('admin/slider') ? 'active':''}}">
                                <i class="fas fa-bars nav-icon"></i>
                                <p>List</p>
                            </a>
                        </li>
                 ...
                 <li class="nav-item {{Request::is('admin/attribute*') ? 'menu-is-opening menu-open':''}}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item {{Request::is('admin/color*') ? 'menu-is-opening menu-open':''}}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{routeHelper('color')}}" class="nav-link {{Request::is('admin/color/create') ? 'active':''}}">
                                        <i class="fas fa-plus-circle nav-icon"></i>
                                        <p>Add</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{routeHelper('color')}}" class="nav-link {{Request::is('admin/color') ? 'active':''}}">
                                        <i class="fas fa-bars nav-icon"></i>
                                        <p>List</p>
                                    </a>
                                </li>
                ...
                <li class="nav-item {{Request::is('admin/coupon*') ? 'menu-is-opening menu-open':''}}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{routeHelper('coupon')}}" class="nav-link {{Request::is('admin/coupon') ? 'active':''}}">
                                <i class="fas fa-bars nav-icon"></i>
                                <p>List</p>
                            </a>
                        </li>
...
@if(auth()->user()->desig ==1 || auth()->user()->desig ==2)
                <li class="nav-item {{Request::is('admin/brand*') ? 'menu-is-opening menu-open':''}}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{routeHelper('brand')}}" class="nav-link {{Request::is('admin/brand') ? 'active':''}}">
                                <i class="fas fa-bars nav-icon"></i>
                                <p>List</p>
                            </a>
                        </li>
...
@if(auth()->user()->desig ==1)
                <li class="nav-item {{Request::is('admin/tag*') ? 'menu-is-opening menu-open':''}}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{routeHelper('tag')}}" class="nav-link {{Request::is('admin/tag') ? 'active':''}}">
                                <i class="fas fa-bars nav-icon"></i>
                                <p>List</p>
                            </a>
                        </li>
   ...
   @endif
    @if(auth()->user()->desig ==1 || auth()->user()->desig ==2 ||auth()->user()->desig ==3)
                <li class="nav-item {{Request::is('admin/product*') ? 'menu-is-opening menu-open':''}}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{route('admin.product.inhouse.index')}}" class="nav-link {{Request::is('admin/inhouse') ? 'active':''}}">
                                <i class="fas fa-bars nav-icon"></i>
                                <p>Inhouse Product</p>
                            </a>
                        </li>
                         <li class="nav-item">
                            <a href="{{route('admin.low.product')}}" class="nav-link {{Request::is('admin/inhouse') ? 'active':''}}">
                                <i class="fas fa-bars nav-icon"></i>
                                <p>Low Product</p>
                            </a>
                        </li>
    ...
    @if(auth()->user()->desig ==1 || auth()->user()->desig ==2|| auth()->user()->desig ==4)
                <li class="nav-item {{Request::is('admin/order*') ? 'menu-is-opening menu-open':''}}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{routeHelper('order')}}" class="nav-link {{Request::is('admin/order') ? 'active':''}}">
                                <i class="fas fa-bars nav-icon"></i>
                                <p>All</p>
                            </a>
                            ...
                            <a href="{{routeHelper('order/processing')}}" class="nav-link {{Request::is('admin/order/processing') ? 'active':''}}">
  ...
  @if(auth()->user()->desig ==1 || auth()->user()->desig ==2)
                <li class="nav-item {{Request::is('admin/customer*') ? 'menu-is-opening menu-open':''}}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{routeHelper('customer')}}" class="nav-link {{Request::is('admin/customer') ? 'active':''}}">
                                <i class="fas fa-bars nav-icon"></i>
                                <p>List</p>
                            </a>
                        </li>
              ...
              @endif
                ...
                <li class="nav-item {{Request::is('admin/vendor*') ? 'menu-is-opening menu-open':''}}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{routeHelper('vendor/create')}}" class="nav-link {{Request::is('admin/vendor/create') ? 'active':''}}">
                                <i class="fas fa-plus-circle nav-icon"></i>
                                <p>Add</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{routeHelper('vendor')}}" class="nav-link {{Request::is('admin/vendor') ? 'active':''}}">
                                <i class="fas fa-bars nav-icon"></i>
                                <p>List</p>
                            </a>
                        </li>
                         <li class="nav-item">
                            <a href="{{route('admin.vendor.withdraw')}}" class="nav-link {{Request::is('admin/vendor/withdraw') ? 'active':''}}">
                                <i class="fas fa-bars nav-icon"></i>
 ...
 @if(auth()->user()->desig ==1 || auth()->user()->desig ==2)
                ...
                <li class="nav-item {{Request::is('admin/blog*') ? 'menu-is-opening menu-open':''}}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{route('admin.index')}}" class="nav-link {{Request::is('admin/profile/show') ? 'active':''}}">
                                <p>Own Blogs List  </p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{route('admin.user_blog')}}" class="nav-link {{Request::is('admin/profile/show') ? 'active':''}}">
                                <p>User Blogs List  </p>
                            </a>
                        </li>
                        
                        <li class="nav-item">
                            <a href="{{route('admin.new_blog')}}" class="nav-link {{Request::is('admin/profile/change-password') ? 'active':''}}">
                                <p>Add New  </p>
                            </a>
                        </li>
                    </ul>
