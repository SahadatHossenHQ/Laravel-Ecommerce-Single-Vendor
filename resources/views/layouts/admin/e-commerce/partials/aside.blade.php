...
<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background:#1A1A1D;">
    <!-- Brand Logo -->
    <a href="{{route('admin.dashboard')}}" class="brand-link">
        <img src="/uploads/setting/{{setting('logo')}}" alt="Logo" class="brand-image"
            style="opacity:1; float:left; width:90;">
            <span>{{$shop->name ?? "YoungStars IT"}}</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item ">
                    <a href="{{ route('admin.fb-review.index') }}" class="nav-link {{ Request::is('admin/fb-review/index') ? 'active' : '' }}">
