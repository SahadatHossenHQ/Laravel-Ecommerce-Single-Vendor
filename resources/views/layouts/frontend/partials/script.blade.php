...
<script>
  ...
  const texts = ['{!! setting("placeholder_one") !!}', '{!! setting("placeholder_two") !!}', '{!! setting("placeholder_three") !!}', '{!! setting("placeholder_four") !!}'];
...
<!-- GLOBAL JS/ INTERNAL JS _@stack('internal_js') --><script type="text/javascript">@php
