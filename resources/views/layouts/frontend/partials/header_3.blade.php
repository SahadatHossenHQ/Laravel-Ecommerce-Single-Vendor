...
<header class="not-home">
    <div class="top-header header_area" style="background:var(--optional_color);color:var(--optional_bg_color_text)">
        <div class="container-fluid containe">
            ...
            <div class="APP_NAME" style="padding-left:1.2rem;">
                <a style="color:var(--optional_bg_color_text);" href="{{route('home')}}">{{ env('APP_NAME') }}</a>
            </div>
            ...
            {{-- <div class="header-category-wrap">
                <div id="top_categories_wrapper" class="header-category-nav" style="position:relative;padding: 0 10px 0 0 !important">
                    ...
                    <section id="top_categories" class="hero-area">
                        <div class="container">
