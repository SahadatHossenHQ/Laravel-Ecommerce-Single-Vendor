                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="main" id="mainCategory"  class="category form-control" required>
                                ...
                                <option {{$hascategories->id==$category->id ? 'selected':''}} value="{{$category->id}}">{{$category->name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" placeholder="Write category name" class="form-control @error('name') is-invalid @enderror" value="{{ $extra->name ?? old('name') }}" required autocomplete="off">
                            @error('name')
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="cover_photo" id="cover_photo" accept="image/*" class="form-control @error('cover_photo') is-invalid @enderror" data-default-file="@isset($extra) /uploads/extra-category/{{$extra->cover_photo}}@enderror">
                            @error('cover_photo')
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" name="status" id="status" @isset ($extra) {{ $extra->status ? 'checked':'' }} @else checked @endisset>
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" name="is_feature" id="is_feature" @isset ($extra) {{ $extra->is_feature ? 'checked':'' }} @else checked @endisset>
