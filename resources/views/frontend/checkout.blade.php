                ...
                <div class="widget3 col-md-7">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group ">
                            ...
                            <input name="country" id="country" value="Bangladesh" class="form-control @error('country') is-invalid @enderror" type="hidden"  />
                            @error('country')
                                <small class="form-text text-danger">{{$message}}</small>
                            @enderror
                        </div>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input required name="address" placeholder="For Example: House# 123, Street# 123, ABC Road" id="address" class="form-control @error('address') is-invalid @enderror" type="text" value="{{$order->address ?? $address}}" />
                            @error('address')
                                <small class="form-text text-danger">{{$message}}</small>
                            @enderror
                        </div>
...
z-index: -9;
  ...
  <div class="card">
    <div class="card-header" id="headingOne">
        <h5 class="mb-0">
            <div class="" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true"
    ...
    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                    ...
                    <div class="card">
                        ...
                        <div style="margin-bottom: 10px;display: flex;" class="product">
                            ...
                            <a style="margin-left:10px" href="{{route('product.details', $item->options->slug)}}">{{$item->name}}</a>
                             <?php 
                        ...
                        <div class="rvinfo">
                            ...
                            <span>+ <span id="ship-charge">@if(isset($order->shipping_charge)) {{$order->single_charge*$seller_count}} @else 0.00 @endif</span><strong> Tk</strong></span>
                        </div>
