<div class="row" style="border-bottom: 1px solid gainsboro;padding-bottom: 10px;">
             ...
             <span><strong style="color: #108b3a">Tk.{{$product->price ?? $product->discount_price}}</strong> <del>Tk.{{$product->regular_price}}</del></span>
            @else
               <span><strong style="color: #108b3a">Tk.{{$product->regular_price}}</strong></span>
            @endif</p>
